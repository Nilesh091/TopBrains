...
namespace IdentityDemo.Controllers
{
    public class AccounttController : Controller
    {
        ...
        public AccounttController(ApplicationDbContext context)
        {
            _context = context;
        }
