    ...
    public class UserRepository : IUserRepository
    {
        ...
        private User MapToDomain(ApplicationUser appUser)
        {
            ...
            return new User
            {
                ...
                OtpCode = appUser.OtpCode,
                OtpExpiryTime = appUser.OtpExpiryTime,
                OtpAttempts = appUser.OtpAttempts,
                IsTwoFactorEnabled = appUser.IsTwoFactorEnabled
            };
        }
        ...
        public async Task<bool> UpdateUserAsync(User user)
        {
            ...
            appUser.OtpCode = user.OtpCode;
            appUser.OtpExpiryTime = user.OtpExpiryTime;
            appUser.OtpAttempts = user.OtpAttempts;
            appUser.IsTwoFactorEnabled = user.IsTwoFactorEnabled;
