...
namespace UserService.Infrastructure.Persistence
{
    ...
    public class UserDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, Guid>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            var sellerRoleId = Guid.Parse("7d5c4e8a-1234-4b5c-8f2e-9a8b7c6d5e4f");
            var buyerRoleId = Guid.Parse("8e6d5f9b-2345-4c6d-9a3f-0b9c8d7e6f5d");
            ...
            new ApplicationRole
            {
                ...
                ConcurrencyStamp = "5c93e955-dfa7-471a-aefc-2db6d9b08d1c"
            },
            new ApplicationRole
            {
                Id = customerRoleId,
                ...
                ConcurrencyStamp = "e42c89aa-dfc4-4de5-b085-e528449a33f0"
            },
            new ApplicationRole
            {
                Id = vendorRoleId,
                ...
                ConcurrencyStamp = "fe990641-8712-4c18-a32e-eaea30c1db6b"
            },
            new ApplicationRole
            {
                Id = sellerRoleId,
                ...
                ConcurrencyStamp = "a1b2c3d4-e5f6-4g7h-8i9j-0k1l2m3n4o5p"
            },
            new ApplicationRole
            {
                Id = buyerRoleId,
                ...
                ConcurrencyStamp = "b2c3d4e5-f6g7-4h8i-9j0k-1l2m3n4o5p6q"
            }
            );
